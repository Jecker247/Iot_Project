...
public class DownloadFileconnectionDK {

    public String postDataDW;
    public String nameFile;
    public String saveDir;
    public String mexExe;
    ...
    public void downloadFile()throws IOException {
        ...
        if (responseCode == HttpURLConnection.HTTP_OK) {
            ...
            mexExe= "Status operazione: "+ "Il File "+nameFile+" è stato scaricato e si trova nella cartella "+nomeCartella;

        } else {
            //else

            mexExe="Status operazione: Il File "+nameFile+" non è stato scaricato. Riprovare";
